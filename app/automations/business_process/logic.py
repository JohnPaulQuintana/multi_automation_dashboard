from app.config.loader import SS_USERNAME, SS_PASSWORD, WB_USERNAME, WB_PASSWORD, WB_DRIVE, WB_WINBDT_SHEET
...
def winbdt(job_id, data: BusinessAutomationInput):
    ...
    all_data = process_data(
        job_id,
        WB_USERNAME, WB_PASSWORD, startDate, endDate, data.timeGrain, WB_DRIVE, WB_WINBDT_SHEET
    )
